class Enemy 
{
	...
	constructor ( position )
	{
		...
		this.hitSound = game.add.audio ( 'enemyHit' );
	}
	...
	/*
	 *	Animate the enemy based on movement direction
	 * */
	animate ( )
	{
	...
	attack ( )
	{
		...
		//	Check the enemy isn't dead, and the player is in enemy attack range
