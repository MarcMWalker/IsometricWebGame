var selectState = {
	...
	create : function ( )
	{
		...
		//	Select Tuscan Knight
		this.create_button ( "Choose Tuscan Knight", game.world.centerX - 464,game.world.centerY + 164, 300, 100, function ( ) { 
		...
		//	Select Green Knight
		this.create_button ( "Choose Green Knight", game.world.centerX ,game.world.centerY + 164, 300, 100, function ( ) { 
		...
		//	Select Black Knight
		this.create_button ( "Choose Black Knight", game.world.centerX + 464,game.world.centerY + 164, 300, 100, function ( ) { 
